...
#' }
#
Lrnr_david_earth_pois <- R6Class(
  classname = "Lrnr_david_earth_pois", inherit = Lrnr_base,
  ...
  private = list(
    ...
    .train = function(task) {
      ...
      fit_object <- sl3:::call_with_args(getS3method("earth", "default"), args)
      return(fit_object)
    },
