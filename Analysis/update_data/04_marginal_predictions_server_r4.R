...
total_mortalities_by_minority_boot_results <- bootstrap_marginal_predictions(target_variable = "EPL_MINRTY", 
                                                                         ...
                                                                         sub_cat_vars = top_var_subcat_vars[[2]],
                                                                         data_original = data_original,
                                                                         covars = covars,
                                                                         percents = percents,
                                                                         pop = data_original$Population,
...
saveRDS(total_mortalities_by_minority_boot_results, here("Analysis/update_data/data/processed/total_mortalities_by_minority_boot_results.RDS"))
