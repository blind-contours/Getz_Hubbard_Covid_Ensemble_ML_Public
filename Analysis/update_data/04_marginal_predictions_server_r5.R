...
total_mortalities_by_pub_trans_boot_results <- bootstrap_marginal_predictions(target_variable = "pct_taking_Public_transportation_2018", 
...
saveRDS(total_mortalities_by_pub_trans_boot_results, here("Analysis/update_data/data/processed/total_mortalities_by_pub_trans_boot_results.RDS"))
