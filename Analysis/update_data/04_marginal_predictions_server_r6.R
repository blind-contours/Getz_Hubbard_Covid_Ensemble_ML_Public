...
saveRDS(total_mortalities_by_prop_black_ind_boot_results, here("Analysis/update_data/data/processed/total_mortalities_by_prop_black_ind_boot_results.RDS"))
